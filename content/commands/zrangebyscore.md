{
  ...
  "deprecated": true,
  "syntax": "key min max [WITHSCORES] [LIMIT offset count]",
  "acl_categories": [
    "sortedset",
    "slow"
  ]
...
As per Redis 6.2.0, this command is considered deprecated. Please prefer using the [ZRANGE](/commands/zrange) command with the `BYSCORE` argument in new code.
...
Normally [ZRANGEBYSCORE](/commands/zrangebyscore) is simply used in order to get range of items
