...
completely removed from a cluster, the [CLUSTER FORGET](/commands/cluster-forget) command must be
...
[CLUSTER FORGET](/commands/cluster-forget) commands to all the nodes ASAP hoping there are no
