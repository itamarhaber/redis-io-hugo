...
Your application may also use the information reported by the [OBJECT](/commands/object) command
to implement application level key eviction policies when using Redis as a
Cache.

The [OBJECT](/commands/object) command supports multiple sub commands:
