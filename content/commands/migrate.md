...
* `KEYS` -- If the key argument is an empty string, the command will instead migrate all the keys that follow the [KEYS](/commands/keys) option (see the above section for more info).
