...
This is not guaranteed if the client uses simply [SAVE](/commands/save) and then [QUIT](/commands/quit) because
...
configured, nor "save" directive) will not dump the RDB file on [SHUTDOWN](/commands/shutdown), as
