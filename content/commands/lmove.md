...
[LMOVE](/commands/lmove) (or [BLMOVE](/commands/blmove) for the blocking variant) offers a way to avoid
...
Using [LMOVE](/commands/lmove) with the same source and destination key, a client can visit
