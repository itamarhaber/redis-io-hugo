...
The [XPENDING](/commands/xpending) command is the interface to inspect the list of pending
...
When [XPENDING](/commands/xpending) is called with just a key name and a consumer group
...
message without acknowledging its processing. The simple [XPENDING](/commands/xpending)
...
The [XPENDING](/commands/xpending) command allows iterating over the pending entries just like
