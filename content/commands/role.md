...
An example of output when [ROLE](/commands/role) is called in a master instance:
...
An example of output when [ROLE](/commands/role) is called in a replica instance:
